...
const SearchItem = ({item, onClick}) => {
	...
	return(
		<div  className="box is-flex is-flex-direction-row m-2 p-2 is-align-items-center"   style={{backgroundColor: item.coverImage.color + "50", width:"100%"}} onClick={() => onClick(item.title.romaji, item.id)} >
